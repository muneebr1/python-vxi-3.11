...
setup(
  name = 'vxi311',  # Your desired distribution name for PyPI
...
instrument control protocol for controlling VXI11 and LXI compatible instruments.''',
  ...
  # Keep the package directory as vxi11
  packages = ['vxi11'],
  # Tell the build process where to find the package code
  package_dir = {'vxi311': 'vxi11'},  # Replace 'vxi311' with your chosen name if different
  entry_points = {
    'console_scripts': [
